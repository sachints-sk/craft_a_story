    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.popUntil(context, ModalRoute.withName('CraftAStoryApphome'));
          },
        ),
        title: const Text('Crafted Story',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
      ),
